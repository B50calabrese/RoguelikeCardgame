#ifndef DECK_BUILDER_GAME_CORE_CARD_REGISTRY_H_
#define DECK_BUILDER_GAME_CORE_CARD_REGISTRY_H_
...
// Singleton registry that manages all cards in the game.
class CardRegistry {
 public:
  static CardRegistry& Get();

  // Loads all card XML files from a directory.
...
#endif  // DECK_BUILDER_GAME_CORE_CARD_REGISTRY_H_
