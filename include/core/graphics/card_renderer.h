#ifndef DECK_BUILDER_GAME_CORE_GRAPHICS_CARD_RENDERER_H_
#define DECK_BUILDER_GAME_CORE_GRAPHICS_CARD_RENDERER_H_
...
// Utility class to draw game cards.
...
class CardRenderer {
 public:
  // Renders a complete card with all its layers.
...
#endif  // DECK_BUILDER_GAME_CORE_GRAPHICS_CARD_RENDERER_H_
