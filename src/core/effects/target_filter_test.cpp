...
TEST_F(TargetFilterTest, AllowPlayer) {
  ...
  Target self_target;
  self_target.type = Target::Type::kPlayer;
  self_target.id = 0;

  Target enemy_target;
  enemy_target.type = Target::Type::kEnemy;
  enemy_target.id = 1;
...
TEST_F(TargetFilterTest, AllowCreature) {
  ...
  Target target;
  target.type = Target::Type::kCreature;
  target.id = 100;
...
TEST_F(TargetFilterTest, StatsConstraints) {
  ...
  Target t1{Target::Type::kCreature, 1};
  Target t2{Target::Type::kCreature, 2};
  Target t3{Target::Type::kCreature, 3};
